...
10.times do |index|
    ...
    School.all.each do |school|
        ...
        school.teachers.each do |teacher|
            ...
            studentCourse = teacher.student_courses.create!(time: Faker::Time.backward(days: 5, period: :morning, format: :short))
            ...
            CourseEnrollment.create(student_id: selected_student.id, student_course_id: studentCourse.id)
            end
